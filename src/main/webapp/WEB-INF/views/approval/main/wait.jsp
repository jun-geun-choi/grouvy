  ...
  <main>
    <div class="container">
        ...
        <div class="sidebar-section">
          ...
          <ul class="sidebar-list">
            <li class="active"><a href="/approval/main/wait" style="text-decoration: none; color: inherit;">결재대기함 <span class="badge">0</span></a></li>
            ...
            <tbody>
              <c:forEach var="approvalWait" items="${approvalsWait }" varStatus="loop">
                <tr>
                  ...
                  <td>${loop.count}</td>
                  <td>공통</td>
                  <td>${approvalWait.approvalNo }</td>
                  <td>수신</td>
                  <td><a href="/approval/waitDetail?no=${approvalWait.approvalNo}">${approvalWait.title}</a></td>
                  <td>${approvalWait.writerName}</td>
                  <td>${approvalWait.approvalDepartmentName}</td>
                  <td>
                    <fmt:formatDate value="${approvalWait.createdDate}" pattern="yyyy-MM-dd HH:mm:ss" />
                  </td>
                  <td>
                    <fmt:formatDate value="${approvalWait.assignedDate}" pattern="yyyy-MM-dd HH:mm:ss" />
                  </td>
                </tr>
              </c:forEach>
            </tbody>
