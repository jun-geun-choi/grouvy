      ...
      <div id="completeContent">
        ...
        <div class="table-container">
          <table class="table table-hover">
            ...
            <tbody>
                <c:forEach var="approvalComplete" items="${approvalCompleteList}" varStatus="loop">
                  <tr>
                    <td><input type="checkbox" class="form-check-input"></td>
                    <td>공통</td>
                    <td>도서구입신청서</td>
                    <td>${approvalComplete.approvalNo}</td>
                    <td><a href="/approval/completeDetail?no=${approvalComplete.approvalNo}">${approvalComplete.title}</a></td>
                    <td>${approvalComplete.writerName}</td>
                    <td>${approvalComplete.requestDepartmentName}</td>
                    <td><fmt:formatDate value="${approvalComplete.completedDate}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                  </tr>
                </c:forEach>
            </tbody>
          </table>
