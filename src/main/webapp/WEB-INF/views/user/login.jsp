...
<div class="auth-card">
    ...
    <form action="/login" method="post">
        <!-- TODO : <sec:csrfInput/> -->
        <div class="mb-3">
            <label for="loginEmail" class="form-label small">이메일</label>
            <input type="text" class="form-control" id="loginEmail" name="email" required>
        </div>
        <!-- name="email" : SecurityConfig 설정에 따름 -->
        <div class="mb-3">
            <label for="loginPw" class="form-label small">비밀번호</label>
            <input type="password" class="form-control" id="loginPw" name="password" required>
        </div>
