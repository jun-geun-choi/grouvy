			...
			<div class="sidebar">
				...
				<div class="sidebar-section">
					...
					<ul class="sidebar-list">
						<li class="active"><a href="/task/todo" class="sidebar-link">할 일 목록</a></li>
					</ul>
				</div>
				<div class="sidebar-section">
...
<%--				</form>--%>
				...
				<table class="task-table">
					...
					<c:forEach var="todo" items="${todos}">
						<tr>
							<td><input type="checkbox" name="taskIds" value="${todo.taskId}"></td>
							<td>
								<a href="<c:url value='/task/todo/detail/${todo.taskId}'/>"
							...
							<td><span class="status
							   ${todo.status == '등록됨' ? 'status-registered' : ''}
							   ${todo.status == '완료'  ? 'status-completed'  : ''}">${todo.status}</span></td>
						</tr>
					</c:forEach>
